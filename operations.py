...
class operation:
    def install_uv_and_run_script(email):
        ...
        datagen_path = r"D:\data_Science\project_1\datagen.py"
    ...
    def format_file_with_prettier(file_path):
        try:
            ...
            subprocess.run(
                ["npx", "--version"], check=True, capture_output=True, text=True
            )
            ...
            raise RuntimeError(
                "npx is not installed or not available in the system's PATH."
            )
    ...
    def extract_sender_email():
        input_file = r"D:\data_Science\project_1\data\email.txt"
        output_file = r"D:\data_Science\project_1\data\email-sender.txt"

        if not os.path.exists(input_file):
            raise HTTPException(
                status_code=404, detail=f"Input file {input_file} does not exist."
            )
    ...
    def extract_credit_card_number():
        input_image = r"D:\data_Science\project_1\data\credit_card.png"
        output_file = r"D:\data_Science\project_1\data\credit-card.txt"
